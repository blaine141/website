...
function openProject(project) {
    ...
    document.getElementsByClassName("projectWindow")[0].style.width = (viewport.width() * .95) + "px";
    if (viewport.width() < 800)
        document.getElementsByClassName("projectWindow")[0].style.width = (viewport.width() * .93) + "px";
    projectOpen = true;
}
...
if (!isMobile) {
    ...
    viewport.on('scroll', function () {
        stickyNavigation();
        if (viewport.scrollTop() < $(document).height())
